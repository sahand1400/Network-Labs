...
###  به روتری که از دنیای بیرون روت Redistribute کند  Autonomous System Border Router  (ASBR) میگویند.  
...
### در ospf روت ها وقتی از دنیای بیرون وارد میشوند متریکشان 20 است که این متریک 20 را عوض کرد.
</div>
...
### Helloها هر 10 ثانیه یکبار ارسال می شود. HOLD Time ها برابر 40 ثانیه است میتوان این مقدار را کمتر کنیم که خرابی را سریعتر تشخیص داده می شودتغییر در داخل اینترفیس ها انجام میشود و در لینک بکاپ تغییر تایمر را لازم نداریم 
