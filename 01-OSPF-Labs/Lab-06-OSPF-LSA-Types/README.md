...
### 1- Transit:
 ### یعنی یک دست روتر رفته یکجایی Nighbor شده که باید DR انتخاب شود در روتر R2 چون اترنت نداریم پس DR نداریم.
### 2-Point-To-Point:
### یعنی این اینترفیس با کسی رابطه همسایگی پیدا کرده که  DR ندارد.
### 3-Stub: 
### جاهایی هستند که رابطه همسایگی شکل نگرفته است.
